...
Honest strongest claim: `Score plans by recoverability under physical deviation, not just nominal feasibility.` is a plausible branch-structured mechanism for task and motion planning, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
